...
const menu = [
  ...
  { name: "Ağ Teknolojileri", active: true, href: "/ag-teknolojileri" },
...
const agUrunleri = [
  { 
    ad: "8 Port PoE Switch", 
    kategori: "Network Switch",
    fiyat: "₺3,850",
    stok: "12",
    durum: "Aktif",
  ...
  { 
    ad: "Wireless Access Point", 
    kategori: "Kablosuz Ağ",
    fiyat: "₺1,950",
    stok: "15",
    durum: "Aktif",
    durumRenk: "bg-green-100 text-green-700"
...
const TekilUrunFaturaPDF = ({ urun }: { urun: Urun }) => {
  const faturaNo = `AT${Math.floor(Math.random() * 1000000)}`;
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>KS1 Teknok - Ağ Teknolojileri</Text>
...
export default function AgTeknolojileri() {
  return (
    <div className="flex min-h-screen bg-gray-50">
            ...
            {menu.map((item) => (
              <Link href={item.href} key={item.name}>
                ...
                >
                  ...
                  {item.name === "Ağ Teknolojileri" && (
                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" /></svg>
                  )}
                  {item.name}
                </div>
              </Link>
      ...
      <main className="flex-1 p-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-2xl font-bold text-gray-900">Ağ Teknolojileri</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow">
            <div className="flex justify-between items-center mb-4">
              <div className="font-semibold text-lg">Ağ Ürünleri</div>
