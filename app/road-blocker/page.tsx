...
const roadBlockerUrunleri = [
  { 
    ad: "Hidrolik Road Blocker", 
  ...
  { 
    ad: "Elektrikli Road Blocker", 
    kategori: "Elektrikli Sistem",
    fiyat: "₺65,000",
    stok: "5",
    durum: "Aktif",
    durumRenk: "bg-green-100 text-green-700"
  ...
  { 
    ad: "Yarı Otomatik Road Blocker", 
    kategori: "Yarı Otomatik",
    fiyat: "₺45,000",
    stok: "8",
    durum: "Aktif",
    durumRenk: "bg-green-100 text-green-700"
  ...
  { 
    ad: "Manuel Road Blocker", 
    kategori: "Manuel Sistem",
    fiyat: "₺35,000",
    stok: "12",
    durum: "Aktif",
    durumRenk: "bg-green-100 text-green-700"
...
const TekilUrunFaturaPDF = ({ urun }: { urun: Urun }) => {
  const faturaNo = `RB${Math.floor(Math.random() * 1000000)}`;
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>KS1 Teknok - Road Blocker</Text>
      ...
      <main className="flex-1 p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl p-6 shadow flex flex-col items-center">
            ...
            <div className="text-green-600 text-xs mt-1">+3.5%</div>
          </div>
          <div className="bg-white rounded-xl p-6 shadow flex flex-col items-center">
          ...
          <div className="bg-white rounded-xl p-6 shadow flex flex-col items-center">
            ...
            <div className="text-green-600 text-xs mt-1">+5.8%</div>
          </div>
          <div className="bg-white rounded-xl p-6 shadow flex flex-col items-center">
            <div className="text-sm text-gray-500 mb-2">Stok Uyarısı</div>
            <div className="text-3xl font-bold">2</div>
            <div className="text-red-600 text-xs mt-1">-1.5%</div>
          </div>
        </div>

        {/* Tablolar */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Road Blocker Ürünleri */}
